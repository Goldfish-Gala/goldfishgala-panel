        ...
        <div>
            {isFetching ? (
                ...
                <form className="space-y-5 dark:text-white" action={handleSubmit}>
                    <div>
                        <label htmlFor="fish_type_id">Kategori Ikan</label>
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <ReactSelect
                                        ...
                                        options={[
                                            {
                                                value: fishTypes ? fishTypes[0].fish_type_id : '',
                                                label: 'Kecil (3cm - 5cm)',
                                            },
                                            {
                                                value: fishTypes ? fishTypes[1].fish_type_id : '',
                                                label: 'Sedang (6cm - 8cm)',
                                            },
                                            {
                                                value: fishTypes ? fishTypes[2].fish_type_id : '',
                                                label: 'Jumbo (9cm ke atas)',
                                            },
                                        ]}
                                        styles={{
                                            control: (provided) => ({
                        ...
                        {errors.fish_type_id && <p className="text-red-400">{errors.fish_type_id}</p>}
                    </div>
                    <div>
                    ...
                    <div className="flex justify-start gap-2 md:gap-6">
                        ...
                        <div className="relative flex items-center text-white-dark">
                            ...
                            <div>
                                ...
                                {errors.fish_image1 && <p className="mt-1 text-red-500">{errors.fish_image1}</p>}
                            </div>
                        </div>
                    </div>
                    <div className="flex justify-start gap-2 md:gap-6">
                        ...
                        <div className="relative flex items-center text-white-dark">
                            ...
                            <div>
                                ...
                                {errors.fish_image2 && <p className="mt-1 text-red-500">{errors.fish_image2}</p>}
                            </div>
                        </div>
                    </div>
                    <div className="flex justify-start gap-2 md:gap-6">
                        ...
                        <div className="relative flex items-center text-white-dark">
                            ...
                            <div>
                                ...
                                {errors.fish_image3 && <p className="mt-1 text-red-500">{errors.fish_image3}</p>}
                            </div>
                        </div>
                    </div>
                    <button
                        disabled={isLoading}
                        type="submit"
                        className="btn btn-gradient !mt-16 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]"
                    >
