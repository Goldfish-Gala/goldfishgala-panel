const IconFishList = ({ className }: { className?: string }) => {
    return (
        <svg
            fill="currentColor"
            height="64px"
        ...
        >
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <g>
                    ...
                    <g>
                        {' '}
                        <circle cx="469.4" cy="252.888" r="8.288"></circle>{' '}
                    </g>{' '}
                </g>{' '}
                <g>
                    {' '}
                ...
                <g>
                    ...
                    <g>
                        {' '}
                        <circle cx="287.077" cy="252.888" r="8.288"></circle>{' '}
                    </g>{' '}
                </g>{' '}
                <g>
                    {' '}
                ...
                <g>
                    ...
                    <g>
                        {' '}
                        <circle cx="387.564" cy="383.421" r="8.288"></circle>{' '}
                    </g>{' '}
                </g>{' '}
                <g>
                    {' '}
                ...
                <g>
                    ...
                    <g>
                        {' '}
                        <circle cx="376.168" cy="122.364" r="8.288"></circle>{' '}
                    </g>{' '}
                </g>{' '}
                <g>
                    {' '}
                ...
                <g>
                    ...
                    <g>
                        {' '}
                        <circle cx="193.845" cy="122.364" r="8.288"></circle>{' '}
                    </g>{' '}
                </g>{' '}
                <g>
                    {' '}
                ...
                <g>
                    ...
                    <g>
                        {' '}
                        <circle cx="104.755" cy="252.888" r="8.288"></circle>{' '}
                    </g>{' '}
                </g>{' '}
                <g>
                    {' '}
                ...
                <g>
                    ...
                    <g>
                        {' '}
                        <circle cx="205.242" cy="383.421" r="8.288"></circle>{' '}
                    </g>{' '}
                </g>{' '}
            </g>
        </svg>
